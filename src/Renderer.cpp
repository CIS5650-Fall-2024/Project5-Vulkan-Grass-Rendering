...
void Renderer::CreateComputeDescriptorSetLayout() {
    ...
    VkDescriptorSetLayoutBinding inputBladesLayoutLayoutBinding = {};
    inputBladesLayoutLayoutBinding.binding = 0;
    inputBladesLayoutLayoutBinding.descriptorType = VK_DESCRIPTOR_TYPE_STORAGE_BUFFER;
    inputBladesLayoutLayoutBinding.descriptorCount = 1;
    inputBladesLayoutLayoutBinding.stageFlags = VK_SHADER_STAGE_COMPUTE_BIT;
    inputBladesLayoutLayoutBinding.pImmutableSamplers = nullptr;
    ...
    std::vector<VkDescriptorSetLayoutBinding> bindings = { inputBladesLayoutLayoutBinding, culledBladesLayoutBinding, numBladesLayoutBinding };
