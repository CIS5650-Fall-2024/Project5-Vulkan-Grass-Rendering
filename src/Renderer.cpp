...
void Renderer::CreateComputeDescriptorSetLayout() {
    // TODO-TRY: Create the descriptor set layout for the compute pipeline
    ...
    culledBladesLayoutBinding.binding = 2;
    ...
    std::vector<VkDescriptorSetLayoutBinding> bindings = { numBladesLayoutBinding, bladesLayoutBinding, culledBladesLayoutBinding };
...
void Renderer::CreateComputeDescriptorSets() {
    ...
    std::vector<VkWriteDescriptorSet> descriptorWrites(3 * grassDescriptorSets.size());
